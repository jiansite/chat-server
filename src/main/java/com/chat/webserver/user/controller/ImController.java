package com.chat.webserver.user.controller;
...
import com.chat.server.model.MessageWrapper;
import com.chat.server.model.proto.MessageBodyProto;
import com.chat.server.model.proto.MessageProto;
import com.chat.server.proxy.MessageProxy;
import com.chat.server.session.SessionManager;
import com.chat.webserver.base.controller.BaseController;
import com.chat.webserver.dwrmanage.connertor.DwrConnertor;
import com.chat.webserver.sys.service.FilesInfoService;
import com.chat.webserver.user.model.ImFriendUserData;
import com.chat.webserver.user.model.ImFriendUserInfoData;
import com.chat.webserver.user.model.ImGroupUserData;
import com.chat.webserver.user.model.ImUserData;
import com.chat.webserver.user.model.UserAccountEntity;
import com.chat.webserver.user.model.UserInfoEntity;
import com.chat.webserver.user.model.UserMessageEntity;
import com.chat.webserver.user.service.UserAccountService;
import com.chat.webserver.user.service.UserDepartmentService;
import com.chat.webserver.user.service.UserMessageService;
import com.chat.webserver.util.Pager;
import com.chat.webserver.util.Query;
...
public class ImController extends BaseController {
    ...
    @ResponseBody
    public Object uploadImgFile(@RequestParam MultipartFile file, HttpServletResponse response,
    ...
    @ResponseBody
    public Object uploadAllFile(@RequestParam MultipartFile file, HttpServletResponse response,
            HttpServletRequest request, RedirectAttributes redirectAttributes) throws Exception {
    ...
    public Object sendMsg(HttpServletResponse response, HttpServletRequest request,
        ...
        builder.setReceiver(request.getParameter("receiver"));
